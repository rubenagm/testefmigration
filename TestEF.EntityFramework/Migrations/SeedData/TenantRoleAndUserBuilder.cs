...
namespace TestEF.Migrations.SeedData
{
    public class TenantRoleAndUserBuilder
    {
        private readonly TestEFDbContext _context;
        private readonly int _tenantId;

        public TenantRoleAndUserBuilder(TestEFDbContext context, int tenantId)
        {
            _context = context;
            _tenantId = tenantId;
        }
        ...
        private void CreateRolesAndUsers()
        {
            ...
            if (adminRole == null)
            {
                ...
                var permissions = PermissionFinder
                    .GetAllPermissions(new TestEFAuthorizationProvider())
